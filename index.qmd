...
<section id="hero" class="sp-hero">
  <div class="sp-hero-content">
    ...
    <div class="sp-hero-links">
      ...
      <a href="#projects" class="sp-btn-solid">Explore work</a>
    </div>
  </div>
</section>
  ...
  <div class="sp-container">
    ...
    <div class="sp-about-top">
      <div class="sp-about-text">
        <p>I am a <strong>Climate Scientist</strong> with experience in climate data, atmospheric modelling, and data visualisation. My career has taken me from the Galician coast to Barcelona, Lisbon, London, and back - through universities, conferences, European projects, and a few companies along the way. In numbers: twelve years of a life.</p>
        <p>The common thread through all that coming and going is climate. Understanding it, modelling it, and communicating it.</p>
      </div>
...
<div class="sp-timeline">
  <div class="tls">
    <div class="tlg">
      <span class="tly acad" style="grid-column:1">2014</span>
      <span class="tld acad" style="grid-column:1"></span>
      <div class="tll acad" style="grid-column:2"></div>
      <span class="tlr acad" style="grid-column:2">PhD Student</span>

      <span class="tly acad" style="grid-column:3">2017</span>
      <span class="tld acad" style="grid-column:3"></span>
      <div class="tll acad" style="grid-column:4"></div>
      <span class="tlr acad" style="grid-column:4">Research Assistant</span>

      <span class="tly pro" style="grid-column:5">2018</span>
      <span class="tld pro" style="grid-column:5"></span>
      <div class="tll pro" style="grid-column:6"></div>
      <span class="tlr pro" style="grid-column:6">Climate Scientist</span>

      <span class="tly pro" style="grid-column:7">2021</span>
      <span class="tld pro" style="grid-column:7"></span>
      <div class="tll pro" style="grid-column:8"></div>
      <span class="tlr pro" style="grid-column:8">WRF Specialist</span>

      <span class="tly pro" style="grid-column:9">2023</span>
      <span class="tld pro" style="grid-column:9"></span>
      <div class="tll pro" style="grid-column:10"></div>
      <span class="tlr pro" style="grid-column:10">Climate Scientist</span>

      <span class="tly pro" style="grid-column:11">2026</span>
      <span class="tld now" style="grid-column:11"></span>
    </div>
  </div>
  <div class="tleg">
    <span class="tli"><i class="tlsw acad"></i>Academia</span>
    <span class="tli"><i class="tlsw pro"></i>Industry</span>
    <span class="tli"><i class="tlsw nowsw"></i>Present</span>
  </div>
</div>
...
<!-- ── PROJECTS ── -->
<section id="projects" class="sp-section">
  <div class="sp-container">
    <p class="sp-label">// projects</p>
    <h2 class="sp-section-title">Projects</h2>
    <p class="ms-intro">These are the projects from my career that I’m most proud of. They took the most time, caused the most headaches, and pushed me the furthest. They also shaped how I think about climate.</p>
    <div class="ms-grid">
      ...
      <a href="ucl.html" class="ms-card">
        <p class="ms-card-title">SISAl Project</p>
        <p class="ms-card-desc">Palaeoclimate research at one of the world's top universities, University College London.</p>
        <span class="ms-card-cta">Read more →</span>
      </a>

      <a href="marrisk.html" class="ms-card">
        <p class="ms-card-title">MarRISK Project</p>
        <p class="ms-card-desc">European project assessing coastal climate risks for Galicia and Northern Portugal.</p>
        <span class="ms-card-cta">Read more →</span>
      </a>

      <a href="seasonal-forecasting.html" class="ms-card">
        <p class="ms-card-title">Seasonal Forecasting</p>
        <p class="ms-card-desc">Climate services for Spain's national weather agency.</p>
        <span class="ms-card-cta">Read more →</span>
      </a>

      <a href="FemaleVoices.html" class="sp-work-card">
        <p class="sp-work-title">Female Voices</p>
        <p class="sp-work-desc">Pioneer women in climate science </p>
...
<!-- ── VISUALS ── -->
<section id="visuals" class="sp-section">
  <div class="sp-container">
    <p class="sp-label">// visuals</p>
    <h2 class="sp-section-title">Visuals</h2>
    <p class="sp-section-sub">Climate maps, data visualisations and animations. Click any figure to read the story behind it. [Currently, working on this section]</p>

    <div class="vis-tabs">
      <button class="vis-tab active" data-set="py" onclick="switchSet('py')">Python figures</button>
      <button class="vis-tab" data-set="dw" onclick="switchSet('dw')">Datawrapper</button>
    </div>

    <!-- Python figures: masonry gallery (auto-generated from pyVisuals) -->
    <div class="vis-masonry" id="vis-py"></div>

    <!-- Datawrapper: masonry of chart previews (auto-generated from dwVisuals) -->
    <div class="vis-masonry" id="vis-dw" style="display:none"></div>
  </div>
</section>
...
.sp-hero-sub { font-family: 'DM Sans', sans-serif; font-size: 0.95rem; color: #0A102B; line-height: 1.75; margin-bottom: 2.2rem; }
...
.sp-section-header { margin-bottom: 0; }
...
.sp-section-sub { font-family: 'DM Sans', sans-serif; font-size: 0.88rem; color: #0A102B; margin: 0 0 2rem 0; }
...
.sp-about-text p { font-family: 'DM Sans', sans-serif; font-size: 0.92rem; line-height: 1.8; color: #0A102B; margin-bottom: 1rem; }
...
/* ── Visuals: tabs ── */
.vis-tabs { display: flex; gap: 0.6rem; margin: 0 0 2.2rem 0; flex-wrap: wrap; }
.vis-tab { font-family: 'DM Sans', sans-serif; font-size: 0.78rem; letter-spacing: 0.03em; color: #182547; background: transparent; border: 1px solid rgba(24,37,71,0.2); padding: 0.5rem 1.2rem; border-radius: 100px; cursor: pointer; transition: background 0.2s, color 0.2s, border-color 0.2s; }
.vis-tab:hover { border-color: #182547; }
.vis-tab.active { background: #182547; color: #fff; border-color: #182547; }

/* ── Visuals: masonry gallery (shared by Python + Datawrapper) ── */
.vis-masonry { columns: 280px; column-gap: 1.1rem; }
.vis-item { break-inside: avoid; -webkit-column-break-inside: avoid; margin: 0 0 1.1rem 0; position: relative; display: block; width: 100%; cursor: pointer; overflow: hidden; border-radius: 6px; background: #e8e8e8; box-shadow: 0 1px 6px rgba(24,37,71,0.07); }
.vis-item img, .vis-item video { width: 100%; display: block; transition: transform 0.5s ease; }
.vis-item:hover img, .vis-item:hover video { transform: scale(1.04); }
.vis-ov { position: absolute; inset: 0; display: flex; flex-direction: column; justify-content: flex-end; gap: 0.15rem; padding: 0.9rem; background: linear-gradient(to top, rgba(10,16,43,0.78) 0%, rgba(10,16,43,0) 55%); opacity: 0; transition: opacity 0.25s ease; }
.vis-item:hover .vis-ov { opacity: 1; }
.vis-ov-title { font-family: 'DM Sans', sans-serif; font-size: 0.82rem; font-weight: 500; color: #fff; line-height: 1.3; }
.vis-ov-tag { font-family: monospace; font-size: 0.62rem; letter-spacing: 0.06em; text-transform: uppercase; color: rgba(255,255,255,0.72); }
...
.vl-left.is-embed { background: #fff; align-items: flex-start; justify-content: stretch; overflow-y: auto; padding: 1.2rem; }
.vl-left.is-embed iframe { width: 100% !important; border: none; }
...
/* ── About timeline ── */
.sp-timeline { --acad:#7d8bad; --pro:#182547; margin-top: 3rem; }
.tls { overflow-x: auto; padding-bottom: 0.4rem; }
.tlg { display: grid; grid-template-columns: 18px minmax(max-content,1fr) 18px minmax(max-content,1fr) 18px minmax(max-content,1fr) 18px minmax(max-content,1fr) 18px minmax(max-content,1fr) 18px; grid-template-rows: auto 16px auto; align-items: center; padding: 0 1.4rem; }
.tly { grid-row: 1; justify-self: center; font-family: 'DM Sans', sans-serif; font-size: 0.82rem; font-weight: 600; white-space: nowrap; padding-bottom: 0.55rem; overflow: visible; }
.tly.acad { color: var(--acad); } .tly.pro { color: var(--pro); }
.tld { grid-row: 2; justify-self: center; width: 11px; height: 11px; border-radius: 50%; z-index: 2; }
.tld.acad { background: var(--acad); } .tld.pro { background: var(--pro); }
.tld.now { background: #fafafa; border: 2.5px solid var(--pro); box-shadow: 0 0 0 4px rgba(24,37,71,0.12); }
.tll { grid-row: 2; height: 2px; width: 100%; }
.tll.acad { background: var(--acad); } .tll.pro { background: var(--pro); }
.tlr { grid-row: 3; justify-self: center; font-family: 'DM Sans', sans-serif; font-size: 0.74rem; color: #0A102B; white-space: nowrap; padding: 0.7rem 0.7rem 0; position: relative; }
.tlr::before { content: ''; position: absolute; top: 0.2rem; left: 50%; transform: translateX(-50%); width: 18px; height: 2px; border-radius: 1px; }
.tlr.acad::before { background: var(--acad); } .tlr.pro::before { background: var(--pro); }
.tleg { display: flex; gap: 1.5rem; justify-content: center; margin-top: 1.7rem; }
.tli { display: inline-flex; align-items: center; gap: 0.45rem; font-family: 'DM Sans', sans-serif; font-size: 0.72rem; color: #888; }
.tlsw { width: 10px; height: 10px; border-radius: 50%; display: inline-block; }
.tlsw.acad { background: var(--acad); } .tlsw.pro { background: var(--pro); }
.tlsw.nowsw { width: 9px; height: 9px; background: #fafafa; border: 2px solid #182547; }

/* ── Projects ── */
.ms-intro { font-family: 'DM Sans', sans-serif; font-size: 0.92rem; color: #0A102B; line-height: 1.75; margin: 0 0 2.5rem 0; max-width: 680px; }
...
.sp-contact-left p { font-family: 'DM Sans', sans-serif; font-size: 0.92rem; color: #0A102B; line-height: 1.7; margin-bottom: 1.8rem; }
.sp-contact-btns { display: flex; gap: 0.8rem; flex-wrap: wrap; margin-bottom: 1.8rem; }
.sp-social { display: flex; gap: 1.2rem; }
.sp-social a { color: #888 !important; font-size: 1.9rem; text-decoration: none; transition: color 0.2s; }
...
@media (max-width: 750px) {
  ...
  .vl-left.is-embed { max-height: 55vh; }
...
/* ===========================================================
   VISUALS DATA
   To add a new figure in the future, just append an object
   to the matching array below — the galleries build themselves.

   Python figure fields:
     type: 'img' | 'video'   (required)
     img: path to file        (required)
     tag: short label shown on hover (e.g. 'Water · Static map')
     label, title, descs[], callout, linkedin, meta[], download, downloadName

   Datawrapper fields:
     type: 'datawrapper'      (required)
     id: chart id, e.g. '5EOoe'   (required)
     height: initial px before auto-resize (optional, default 459)
     thumb: preview image (optional, defaults to .../<id>/full.png)
     tag, label, title, alt, descs[], callout, linkedin, meta[]
   =========================================================== */

const pyVisuals = [
  {
    type: 'img', img: 'images/visuals/plot1.jpg',
    tag: 'Meteorology · Static map',
  ...
  {
    type: 'img', img: 'images/visuals/plot2.png',
    tag: 'Water · Static map',
  ...
  {
    type: 'img', img: 'images/visuals/rivers_europe_minimal.png',
    tag: 'Water · Static map',
    label: '// water · static map',
  ...
  {
    type: 'video', img: 'images/visuals/co2-seaice.mp4',
    tag: 'Climate Change · Animation',
  ...
  {
    type: 'img', img: 'images/visuals/01_warming_stripes_galicia.png',
    tag: 'Climate Change · Static chart',
  ...
  {
    type: 'img', img: 'images/visuals/04_spaghetti_current_year.png',
    tag: 'Climate Change · Static chart',
    label: '// climate change · static chart',
    title: 'Maximum Temperature in Galicia over the Years',
    descs: [
      'A spaghetti plot of daily maximum temperature in Galicia. Each faint grey thread is one full year of daily values; the black line is the 1991–2020 daily average, and the red line traces 2026 so far.',
      'Drawing every year as a thread turns a single variable — daily maximum temperature — into the whole climate envelope at once, and shows at a glance where the current year sits within it.'
    ],
    callout: null,
    linkedin: null,
    meta: [
      { label: 'Tools', value: 'Python · Matplotlib' },
      { label: 'Context', value: 'Climate monitoring · Personal project' },
      { label: 'Data', value: 'Copernicus C3S — ERA5-Land' }
    ],
    download: 'images/visuals/04_spaghetti_current_year.png', downloadName: 'galicia-max-temp-spaghetti.png'
  },
  {
    type: 'img', img: 'images/visuals/2nov2025-lines.png',
    tag: 'Meteorology · Static map',
    label: '// meteorology · static map',
    title: 'Atlantic Winds Sweeping Towards Iberia',
    descs: [
      'Wind streamlines over the North Atlantic on Halloween night, with the colour scale showing wind speed in m s⁻¹. The flow lines trace how Atlantic winds curl around low-pressure systems and funnel towards the Iberian Peninsula.',
      'Streamlines turn a vector field — wind speed and direction at every grid point — into something you can read at a glance: where the air is coming from, where it converges, and where it accelerates.'
    ],
    callout: null,
    linkedin: null,
    meta: [
      { label: 'Tools', value: 'Python · Matplotlib · Cartopy' },
      { label: 'Context', value: '#30DayMapChallenge 2025 · Day 2: Lines' },
      { label: 'Data', value: 'WRF 36 km · MeteoGalicia THREDDS' }
    ],
    download: 'images/visuals/2nov2025-lines.png', downloadName: 'atlantic-winds-iberia.png'
  },
  {
    type: 'img', img: 'images/visuals/EEA_extreme_losses_static.png',
    tag: 'Climate Change · Static map',
    label: '// climate change · static map',
    title: 'Economic Losses from Weather Extremes in Europe',
    descs: [
      'Choropleth map of total economic losses from weather- and climate-related extremes across European countries, with each country labelled and shaded by its cumulative loss in million euros. Germany, France, Italy and Spain stand out as the largest absolute losses.',
      'The map makes the scale visible: weather extremes are not only a human and ecological cost but a major economic one, concentrated in the largest economies but felt everywhere.'
    ],
    callout: null,
    linkedin: null,
    meta: [
      { label: 'Tools', value: 'Python · GeoPandas · Matplotlib' },
      { label: 'Context', value: 'Climate risk · Personal project' },
      { label: 'Data', value: 'European Environment Agency (EEA)' }
    ],
    download: 'images/visuals/EEA_extreme_losses_static.png', downloadName: 'eea-extreme-losses-europe.png'
  },
  {
    type: 'img', img: 'images/visuals/CO2_vs_SeaIce_timeline.png',
    tag: 'Climate Change · Static chart',
    label: '// climate change · static chart',
    title: 'CO₂ vs Arctic Sea Ice · 1980–2020',
    descs: [
      'Two rows of bubbles tracking opposing trends by decade. The top row is atmospheric CO₂ concentration at Mauna Loa, rising from 339 ppm in 1980 to 414 ppm in 2020. The bottom row is Arctic sea ice extent, shrinking from 12.6 to 10.4 million km² over the same period.',
      'Reading the two rows together makes the relationship hard to miss: as the red circles darken and the blue circles fade, one signal climbs while the other retreats.'
    ],
    callout: 'These are not independent signals — they are two sides of the same story.',
    linkedin: null,
    meta: [
      { label: 'Tools', value: 'Python · Matplotlib' },
      { label: 'Context', value: '#30DayMapChallenge 2025' },
      { label: 'Data', value: 'NOAA GML (CO₂) · Copernicus Marine (sea ice)' }
    ],
    download: 'images/visuals/CO2_vs_SeaIce_timeline.png', downloadName: 'co2-vs-seaice-timeline.png'
  }
];

const dwVisuals = [
  {
    type: 'datawrapper', id: '5EOoe', height: 459,
    tag: 'Climate Change · Interactive',
    label: '// climate change · interactive',
    title: 'Galicia just lived through its warmest decade on record',
    alt: "Column chart of Galicia's annual mean temperature anomalies from 1950 to 2025, relative to the 1961–1990 average. Bars are mostly below zero before 1990 and increasingly above it afterward, peaking at a record +1.9°C in 2022.",
    descs: [
      "Interactive column chart of Galicia's annual mean temperature anomalies from 1950 to 2025, relative to the 1961–1990 average. Bars sit mostly below zero before 1990 and increasingly above it afterwards, peaking at a record +1.9°C in 2022. Hover over any bar to read the exact value for that year."
    ],
    callout: null,
    linkedin: null,
    meta: [
      { label: 'Tool', value: 'Datawrapper' },
      { label: 'Data', value: 'Edit me in dwVisuals' }
    ]
  },
    {
        type: 'datawrapper', id: 'VWHOC', height: 770,
        tag: 'Climate Change · Interactive',
        label: '// climate change · interactive',
        title: 'How much European cities have warmed',
        alt: 'Symbol map of 36 European cities coloured by how much they have warmed between 1961–1990 and 2015–2024. Inland and eastern cities like Kyiv, Vienna and Milan have warmed about 2.3°C, while Atlantic-coast cities like Dublin, Lisbon and A Coruña have warmed under 1°C.',
        descs: [
          'Symbol map of 36 European cities, each coloured by how much its mean temperature has risen between 1961–1990 and 2015–2024. Click over any city to read its exact warming.',
          'A clear geography emerges: inland and eastern cities like Kyiv, Vienna and Milan have warmed by around 2.3°C, while Atlantic-coast cities like Dublin, Lisbon and A Coruña have warmed by under 1°C.'
        ],
        callout: null,
        linkedin: null,
        meta: [
...
/* ===========================================================
   GALLERY + LIGHTBOX LOGIC  (no need to edit below)
   =========================================================== */

let currentSet = 'py';
let currentVisualIndex = 0;
function activeArr() { return currentSet === 'py' ? pyVisuals : dwVisuals; }

function switchSet(set) {
  currentSet = set;
  document.querySelectorAll('.vis-tab').forEach(t => t.classList.toggle('active', t.dataset.set === set));
  document.getElementById('vis-py').style.display = (set === 'py') ? '' : 'none';
  document.getElementById('vis-dw').style.display = (set === 'dw') ? '' : 'none';
}

function renderGalleries() {
  const py = document.getElementById('vis-py');
  py.innerHTML = pyVisuals.map((v, i) => {
    const media = v.type === 'video'
      ? `<video autoplay loop muted playsinline><source src="${v.img}" type="video/mp4"/></video>`
      : `<img src="${v.img}" alt="${v.title}" loading="lazy"/>`;
    return `<div class="vis-item" onclick="openVisual('py',${i})">${media}<div class="vis-ov"><span class="vis-ov-title">${v.title}</span><span class="vis-ov-tag">${v.tag || ''}</span></div></div>`;
  }).join('');

  const dw = document.getElementById('vis-dw');
  dw.innerHTML = dwVisuals.map((v, i) => {
    const thumb = v.thumb || `https://datawrapper.dwcdn.net/${v.id}/full.png`;
    return `<div class="vis-item" onclick="openVisual('dw',${i})"><img src="${thumb}" alt="${v.alt || v.title}" loading="lazy"/><div class="vis-ov"><span class="vis-ov-title">${v.title}</span><span class="vis-ov-tag">${v.tag || ''}</span></div></div>`;
  }).join('');
}

function stepVisual(dir) {
  const arr = activeArr();
  currentVisualIndex = (currentVisualIndex + dir + arr.length) % arr.length;
  openVisual(currentSet, currentVisualIndex);
}

function openVisual(set, i) {
  currentSet = set;
  ...
  left.classList.toggle('is-embed', v.type === 'datawrapper');
  if (v.type === 'video') {
    left.innerHTML = `<video autoplay loop muted playsinline style="width:100%;height:100%;object-fit:contain;display:block;"><source src="${v.img}" type="video/mp4"/></video>`;
  } else if (v.type === 'datawrapper') {
    const cid = 'datawrapper-vis-' + v.id;
    left.innerHTML = `<div id="${cid}" style="min-height:${v.height || 459}px;width:100%"></div>`;
    const s = document.createElement('script');
    s.type = 'text/javascript';
    s.defer = true;
    s.charset = 'utf-8';
    s.src = `https://datawrapper.dwcdn.net/${v.id}/embed.js`;
    s.setAttribute('data-target', '#' + cid);
    left.appendChild(s);
  } else {
    left.innerHTML = `<img src="${v.img}" alt="${v.title}" style="width:100%;height:100%;object-fit:contain;display:block;"/>`;
  }
  ...
  const downloadHTML = v.download ? `<a href="${v.download}" download="${v.downloadName || ''}" class="vl-download">↓ Download</a>` : '';
...
function closeVisual(e) {
  ...
  document.getElementById('vl-left').innerHTML = '';
  document.body.style.overflow = '';
}

document.addEventListener('keydown', e => {
  const open = document.getElementById('vl-overlay').classList.contains('open');
  if (e.key === 'Escape') { closeVisual(); return; }
  if (!open) return;
...
window.addEventListener('load', function() {
  ...
  particlesJS('particles-js', {
    particles: {
      ...
      line_linked: { enable: true, distance: 150, color: '#deddd9', opacity: 0.7, width: 1.5 },
  ...
  const map = L.map('sp-map', { center: [45, 10], zoom: 3, zoomControl: true, scrollWheelZoom: false });
