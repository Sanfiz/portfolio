...
<section id="milestones" class="sp-section">
  <div class="sp-container">
    ...
    <p class="ms-intro">These are the projects I am most proud of — the ones that took the most time, pushed me furthest, and left the clearest mark on how I think about climate science and data. Each one is a chapter.</p>
    <div class="ms-grid">

      <a href="phd-thesis.html" class="ms-card">
        <span class="ms-card-tag">2014 – 2017</span>
        <p class="ms-card-title">PhD Thesis</p>
        <p class="ms-card-org">Universidade de Santiago de Compostela · University of Lisbon</p>
      ...
      <a href="ucl.html" class="ms-card">
        <span class="ms-card-tag">2018</span>
        <p class="ms-card-title">University College London</p>
        <p class="ms-card-org">UCL · London, United Kingdom</p>
      ...
      <a href="marrisk.html" class="ms-card">
        <span class="ms-card-tag">2018 – 2021</span>
        <p class="ms-card-title">MarRISK</p>
        <p class="ms-card-org">MeteoGalicia · EU Interreg POCTEP</p>
      ...
      <a href="seasonal-forecasting.html" class="ms-card">
        <span class="ms-card-tag">2024 – Present</span>
        <p class="ms-card-title">Seasonal Forecasting at AEMET</p>
        <p class="ms-card-org">Tragsatec – AEMET · Spain</p>
        <p class="ms-card-desc">Climate services for Spain's national meteorological agency — seasonal forecasts, interactive dashboards, geospatial analysis and public data communication.</p>
        <span class="ms-card-cta">Read more →</span>
      </a>
