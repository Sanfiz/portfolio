...
<div class="visual-detail">
  ...
  <div class="code-section">
    ...
    <p class="code-label">1 · Fetch station data from AEMET OpenData API</p>
...
df = pd.DataFrame(observaciones)</pre></div>
    ...
    <p class="code-label">2 · Compute distance from each municipality to nearest station</p>
...
municipios_dist["nearest_dist_km"] = municipios_dist["nearest_dist_m"] / 1000.0</pre></div>
    ...
    <p class="code-label">3 · Plot choropleth map</p>
...
ax.set_title(
    "Areas with Fewer Nearby Spanish Met Service Weather Stations",
    fontsize=11, color="dimgray", pad=10
)
ax.set_axis_off()
plt.savefig("7nov2025-accessibility.png", dpi=300, bbox_inches="tight")</pre></div>
